...
<html>
    ...
    <body>
        <br>
        <h2> Modification de l'employée </h2>
        <br>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="inputAddress" placeholder="adresse" name="adr" required value="${e.adresse}" disabled>
  </div>
   <div class="form-row">
    <div class="form-group col-md-4">
      <label for="inputdate">Date</label>
      <input type="date" class="form-control" id="inputdate" placeholder="date" name="date" required value="${e.dateN}" disabled>
    </div>
    <div class="form-group col-md-4">
      <label for="inputPassword4">Telephone </label>
      <input type="number" class="form-control" id="inputPassword4" placeholder="telephone" name="tel" required value="${e.telephone}" disabled>
    </div>
      <div class="form-group col-md-4">
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-3">
      ...
      <input type="text" class="form-control" id="inputPassword4" placeholder="log" name="log" required value="${e.getEmployeePK().login}" disabled>
    </div>
      <div class="form-group col-md-3">
      <label for="inputPassword4">Mot de passe </label>
      <input type="password" class="form-control" id="inputPassword4" placeholder="mot de passe " name="mp" required value="${e.getEmployeePK().motDePasse}" disabled>
    </div>
     <div class="form-group col-md-3">
         <label for="inputPassword4">confirmation </label><br>
      <select name="conf">
  ...
  <div class="form-group">
    ...
    <input type="hidden" value="maj_admin" name="maj">
